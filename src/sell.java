...
public class sell extends javax.swing.JFrame {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        adminStock admins = new adminStock();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/loginsystem", "root", "PHW#84#jeor");
            ...
            while(rs.next()){
                ...
                String tbData [] = {item_id, item_name, category, serial_no, sale_price, no_of_item, buy_price};
